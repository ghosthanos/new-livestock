...
class Puberty extends StatefulWidget {
  final String cowId;

  const Puberty({Key? key, required this.cowId}) : super(key: key);

  @override
  State<Puberty> createState() => _PubertyState();
}

class _PubertyState extends State<Puberty> {
  final _pubertyDates = <DateTime>[]; // List to store deworming dates

  // Function to add a new deworming date
  void _addPubertyDate() async {
    ...
    if (selectedDate != null) {
      setState(() {
        _pubertyDates.add(selectedDate);
      });
    }
  }

  // Function to delete a deworming date at a specific index
  void _deletepubertyDate(int index) {
    setState(() {
      _pubertyDates.removeAt(index);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: _addPubertyDate, // Call the function to add a new date
      ...
      body: ListView.builder(
        itemCount: _pubertyDates.length,
        itemBuilder: (context, index) {
          final pubertyDate = _pubertyDates[index];
          ...
          return Dismissible(
            ...
            child: ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () =>
                    _deletepubertyDate(index), // Call delete function
              ),
            ),
          );
        },
